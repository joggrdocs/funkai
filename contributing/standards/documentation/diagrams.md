...
| Peach | `#fab387` | Gateways, middleware, providers    |
| Gray  | `#6c7086` | Future/planned, disabled           |

**When to Use Each Color:**

```
Pink (#f5c2e7)   -> External: APIs, webhooks, user requests
Blue (#89b4fa)   -> Internal: Workflows, steps, core services
Green (#a6e3a1)  -> Data: Agents, storage, outputs, success states
Peach (#fab387)  -> Middleware: Providers, hooks, tools
...
- Use short aliases with descriptive labels: `participant A as Agent`
...
| Focused subset of a larger model  | Include attributes for the entities being discussed   | Tool configuration      |
...
13. **Label every relationship** -- Use a verb: `Agent ||--o{ Workflow : runs`
