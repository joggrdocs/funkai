...
Welcome to the funkai contributing docs. This directory contains standards, templates, and guides for working in this codebase.
...
- [Errors](./standards/typescript/errors.md) -- Error handling patterns
...
- [Architecture](./concepts/architecture.md) -- Package ecosystem, design principles, data flow
- [Tech Stack](./concepts/tech-stack.md) -- Tools, libraries, and design rationale
