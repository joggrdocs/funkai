...
1. [`AGENTS.md`](../../AGENTS.md) -- tech stack, project structure, available commands
...
5. Package docs: [`packages/agents/docs/`](../../packages/agents/docs/) and [`packages/prompts/docs/`](../../packages/prompts/docs/)
