...
export interface FlowAgent<TInput, TOutput> {
   ...
   * ```
   */
  generate(params: GenerateParams<TInput, Record<string, Tool>, Record<string, never>, TOutput>): Promise<Result<FlowAgentGenerateResult<TOutput>>>;
   ...
   */
  stream(params: GenerateParams<TInput, Record<string, Tool>, Record<string, never>, TOutput>): Promise<Result<StreamResult<TOutput>>>;

  /**
   * Returns a plain function that calls `.generate()`.
   */
  fn(): (params: GenerateParams<TInput, Record<string, Tool>, Record<string, never>, TOutput>) => Promise<Result<FlowAgentGenerateResult<TOutput>>>;
}
