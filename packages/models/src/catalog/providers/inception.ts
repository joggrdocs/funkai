...
export const INCEPTION_MODELS = [
  { id: 'mercury-2', name: 'Mercury 2', provider: 'inception', family: 'mercury', pricing: { input: 2.5e-7, output: 7.5e-7, cacheRead: 2.5e-8 }, contextWindow: 128000, maxOutput: 50000, modalities: { input: ["text"], output: ["text"] }, capabilities: { reasoning: true, toolCall: true, attachment: false, structuredOutput: true } },
  ...
  { id: 'mercury-edit', name: 'Mercury Edit', provider: 'inception', family: '', pricing: { input: 2.5e-7, output: 7.5e-7, cacheRead: 2.5e-8 }, contextWindow: 128000, maxOutput: 8192, modalities: { input: ["text"], output: ["text"] }, capabilities: { reasoning: true, toolCall: false, attachment: false, structuredOutput: false } },
