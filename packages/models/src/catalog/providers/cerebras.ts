...
export const CEREBRAS_MODELS = [
  ...
  { id: 'llama3.1-8b', name: 'Llama 3.1 8B', provider: 'cerebras', family: 'llama', pricing: { input: 1e-7, output: 1e-7 }, contextWindow: 32000, maxOutput: 8000, modalities: { input: ["text"], output: ["text"] }, capabilities: { reasoning: false, toolCall: true, attachment: false, structuredOutput: false } },
