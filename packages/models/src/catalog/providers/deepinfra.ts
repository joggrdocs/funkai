...
export const DEEPINFRA_MODELS = [
  {
    ...
    provider: "deepinfra",
    family: "glm-flash",
    pricing: { input: 6e-8, output: 4.0000000000000003e-7 },
  ...
  },
  {
    ...
    provider: "deepinfra",
    family: "glm",
    pricing: { input: 8.000000000000001e-7, output: 0.00000256, cacheRead: 1.6e-7 },
    contextWindow: 202752,
    maxOutput: 16384,
    modalities: { input: ["text"], output: ["text"] },
    capabilities: { reasoning: true, toolCall: true, attachment: false, structuredOutput: false },
  },
  {
    ...
    provider: "deepinfra",
    family: "minimax",
    pricing: { input: 2.7e-7, output: 9.499999999999999e-7, cacheRead: 3e-8, cacheWrite: 3.75e-7 },
    contextWindow: 204800,
    maxOutput: 131072,
    modalities: { input: ["text"], output: ["text"] },
    capabilities: { reasoning: true, toolCall: true, attachment: false, structuredOutput: false },
  ...
  },
  {
    ...
    provider: "deepinfra",
    family: "",
    pricing: { input: 5e-7, output: 0.0000021499999999999997, cacheRead: 3.5e-7 },
  ...
  },
  {
    ...
    provider: "deepinfra",
    family: "kimi",
    pricing: { input: 4.0000000000000003e-7, output: 0.000002, cacheRead: 1.5e-7 },
    contextWindow: 262144,
    maxOutput: 262144,
    modalities: { input: ["text"], output: ["text"] },
    capabilities: { reasoning: false, toolCall: true, attachment: false, structuredOutput: false },
  ...
  },
  {
    ...
    pricing: { input: 4.6999999999999995e-7, output: 0.000002 },
    contextWindow: 131072,
    maxOutput: 32768,
    modalities: { input: ["text"], output: ["text"] },
    capabilities: { reasoning: true, toolCall: true, attachment: false, structuredOutput: false },
  ...
  },
  {
    ...
    provider: "deepinfra",
    family: "qwen",
    pricing: { input: 4.0000000000000003e-7, output: 0.0000016000000000000001 },
    contextWindow: 262144,
    maxOutput: 66536,
    modalities: { input: ["text"], output: ["text"] },
    capabilities: { reasoning: false, toolCall: true, attachment: false, structuredOutput: false },
  ...
  },
  {
    ...
    pricing: { input: 0.0000032999999999999997, output: 0.0000165, cacheRead: 3.3e-7 },
