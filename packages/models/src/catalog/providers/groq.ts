...
export const GROQ_MODELS = [
  {
    ...
    provider: "groq",
    family: "llama",
    pricing: { input: 5.9e-7, output: 7.900000000000001e-7 },
    contextWindow: 8192,
    maxOutput: 8192,
  ...
  },
  {
    ...
    provider: "groq",
    family: "llama",
    pricing: { input: 5.0000000000000004e-8, output: 8e-8 },
    contextWindow: 131072,
    maxOutput: 131072,
    modalities: { input: ["text"], output: ["text"] },
    capabilities: { reasoning: false, toolCall: true, attachment: false, structuredOutput: false },
  ...
  },
  {
    ...
    provider: "groq",
    family: "mistral",
    pricing: { input: 7.900000000000001e-7, output: 7.900000000000001e-7 },
    contextWindow: 32768,
    maxOutput: 32768,
    modalities: { input: ["text"], output: ["text"] },
    capabilities: { reasoning: false, toolCall: true, attachment: false, structuredOutput: false },
  ...
  },
  {
    ...
    provider: "groq",
    family: "llama",
    pricing: { input: 1.1e-7, output: 3.4000000000000003e-7 },
    contextWindow: 131072,
    maxOutput: 8192,
