...
export const FIREWORKS_AI_MODELS = [
  ...
  { id: 'accounts/fireworks/models/glm-5', name: 'GLM 5', provider: 'fireworks-ai', family: 'glm', pricing: { input: 0.000001, output: 0.0000032, cacheRead: 5e-7 }, contextWindow: 202752, maxOutput: 131072, modalities: { input: ["text"], output: ["text"] }, capabilities: { reasoning: true, toolCall: true, attachment: false, structuredOutput: false } },
  ...
  { id: 'accounts/fireworks/models/kimi-k2p5', name: 'Kimi K2.5', provider: 'fireworks-ai', family: 'kimi-thinking', pricing: { input: 6e-7, output: 0.000003, cacheRead: 1e-7 }, contextWindow: 256000, maxOutput: 256000, modalities: { input: ["text","image","video"], output: ["text"] }, capabilities: { reasoning: true, toolCall: true, attachment: false, structuredOutput: false } },
  ...
  { id: 'accounts/fireworks/models/glm-4p5', name: 'GLM 4.5', provider: 'fireworks-ai', family: 'glm', pricing: { input: 5.5e-7, output: 0.00000219 }, contextWindow: 131072, maxOutput: 131072, modalities: { input: ["text"], output: ["text"] }, capabilities: { reasoning: true, toolCall: true, attachment: false, structuredOutput: false } },
  { id: 'accounts/fireworks/models/gpt-oss-20b', name: 'GPT OSS 20B', provider: 'fireworks-ai', family: 'gpt-oss', pricing: { input: 5e-8, output: 2e-7 }, contextWindow: 131072, maxOutput: 32768, modalities: { input: ["text"], output: ["text"] }, capabilities: { reasoning: true, toolCall: true, attachment: false, structuredOutput: false } },
