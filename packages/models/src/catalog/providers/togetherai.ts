...
export const TOGETHERAI_MODELS = [
  ...
  { id: 'zai-org/GLM-4.7', name: 'GLM-4.7', provider: 'togetherai', family: 'glm', pricing: { input: 4.5e-7, output: 0.000002 }, contextWindow: 200000, maxOutput: 200000, modalities: { input: ["text"], output: ["text"] }, capabilities: { reasoning: true, toolCall: true, attachment: false, structuredOutput: false } },
  { id: 'zai-org/GLM-5', name: 'GLM-5', provider: 'togetherai', family: 'glm', pricing: { input: 0.000001, output: 0.0000032 }, contextWindow: 202752, maxOutput: 131072, modalities: { input: ["text"], output: ["text"] }, capabilities: { reasoning: true, toolCall: true, attachment: false, structuredOutput: true } },
  ...
  { id: 'Qwen/Qwen3-235B-A22B-Instruct-2507-tput', name: 'Qwen3 235B A22B Instruct 2507 FP8', provider: 'togetherai', family: 'qwen', pricing: { input: 2e-7, output: 6e-7 }, contextWindow: 262144, maxOutput: 262144, modalities: { input: ["text"], output: ["text"] }, capabilities: { reasoning: true, toolCall: true, attachment: false, structuredOutput: false } },
  { id: 'Qwen/Qwen3.5-397B-A17B', name: 'Qwen3.5 397B A17B', provider: 'togetherai', family: 'qwen', pricing: { input: 6e-7, output: 0.0000036 }, contextWindow: 262144, maxOutput: 130000, modalities: { input: ["text","image"], output: ["text"] }, capabilities: { reasoning: true, toolCall: true, attachment: false, structuredOutput: false } },
