...
export const XAI_MODELS = [
  ...
  },
  {
    ...
    provider: "xai",
    family: "grok",
    pricing: { input: 2.0000000000000002e-7, output: 5e-7, cacheRead: 5.0000000000000004e-8 },
    contextWindow: 2000000,
    maxOutput: 30000,
    modalities: { input: ["text", "image"], output: ["text"] },
    capabilities: { reasoning: false, toolCall: true, attachment: true, structuredOutput: false },
  ...
  },
  {
    ...
    provider: "xai",
    family: "grok",
    pricing: { input: 6e-7, output: 0.000004, cacheRead: 1.5e-7 },
    contextWindow: 131072,
    maxOutput: 8192,
    modalities: { input: ["text"], output: ["text"] },
    capabilities: { reasoning: true, toolCall: true, attachment: false, structuredOutput: false },
  ...
  },
  {
    ...
    provider: "xai",
    family: "grok",
    pricing: { input: 3e-7, output: 5e-7, cacheRead: 7.5e-8 },
    contextWindow: 131072,
    maxOutput: 8192,
    modalities: { input: ["text"], output: ["text"] },
    capabilities: { reasoning: true, toolCall: true, attachment: false, structuredOutput: false },
